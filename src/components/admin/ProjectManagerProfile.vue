    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
          ...
          <section class="content">
              <h4 class="text-center">PM Profile</h4>
              <div class="row">
    ...
    export default {
      data(){
           return{
               ...
               projectMangerId:this.$route.params.projectMangerId,
         ...
         created : function(){
           console.log("pproduct owner id ----"+this.$route.params.projectMangerId);

         },
         components:{
             'app-adminHeader':AdminHeader,
             'app-admin-side-bar':AdminSidebar
         },
          mounted:function(){
              var app = this;
              console.log("=====================================")
         ...
         methods:{
           ...
           getProfile: function(){
               ...
               app.$store.commit('setSpinner',true);
                     app.$http.get(
                          app.$store.state.SERVER_URL+'/api/product-owner/get-pm-profile/'+app.projectMangerId, {
                             headers: {
                       ...
                       app.$store.commit('setSpinner',false);
                              ...
                              app.profilePicDocumentId = response.data.payLoad.profilePicDocumentId;
