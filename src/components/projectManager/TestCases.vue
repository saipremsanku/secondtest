<template>
   <div>
      ...
      <button class="btn btn-orange btn-lg pull-left"  data-toggle="modal" v-if="!isAdmin" @click="openTestCaseModal"><i class="fa fa-plus-circle epic-btn-icon" aria-hidden="true"></i> Add Test cases</button>
      <br><br>
                       ...
                       <form id="epicForm" @submit.prevent="addTestCase">
                           ...
                           <div class="form-group epic" :class="{'textarea': true, 'is-danger': errors.has('testCaseData')}">
                            ...
                            <button type="button" class="btn btn-gray" data-dismiss="modal">Close</button>
                             <button type="submit" :disabled="enableButton" class="btn btn-orange" v-if="testCase.testCaseId">Update</button>
                           <button type="submit" :disabled="enableButton" class="btn btn-orange" v-else>ADD</button>
...
<script>
   export default{
       ...
       created:function(){
         ...
         this.isAgreementAvailable = this.$store.getters.getProjectInfo.isAgreementAvailable
       },
       computed:{
         isAdmin:function(){
