               ...
               <table class="table table-hover platform-table-color price-table">
                    ...
                    <tr class="text-center" v-for="(project,index) in allProjectRequirement" v-show="searchResult(project)">
                        ...
                        <td>
                          ...
                          <span>
                            <span @click="" class="admin-title-underline ">{{project.name}}</span>
                       ...
                       <td>
                        ...
                        <td v-if="project.projectManagerName"><p>{{project.projectManagerName}}</p></td>
                        <td v-else>---</td>
        ...
        methods:{
          getStatusRequest(status){
            ...
            getProjectRequirements : function(){
               ...
               app.$http.get(
                        this.$store.state.SERVER_URL+'/api/finance-user/get-all-submitted-project-leads',
                       {
                         headers: {
                   ...
                   console.log("all project response----",response);
                    ...
                    app.allProjectRequirement = response.data.payLoad;
